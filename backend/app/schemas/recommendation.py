...
class RecommendationResponse(BaseModel):
    ...
    category: Literal["hard_skill", "soft_skill", "formatting", "certification"] = Field(..., examples=["hard_skill"])
    title: str = Field(..., examples=["Добавьте навык Docker"])
    description: str = Field(
        ...,
        examples=[
            "Docker — один из самых востребованных навыков для backend-разработчиков. "
